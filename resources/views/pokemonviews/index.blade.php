    ...
    <main class="items-center mx-auto max-w-screen-xl p-4">
        ...
        <section class="flex flex-wrap justify-center mx-auto">
                    @foreach($pokemonList as $pokemon)
                        <div class="w-full sm:w-1/2 md:w-1/2 lg:w-[20%] xl:w-[20%] p-4 m-4 bg-[#FFFFFF] rounded-[12px] shadow-nv ">
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        @foreach ($pokemon['types'] as $type )
                                            <div>
                                                <p class="not-italic text-[10px] font-geologica tracking-normal opacity-[1]">
                                                    {{ $type }}
                                                </p>
                                            </div>
